...
export default function Investissement(props) {
    const {
    ...
    const handleChangeName = (event) => {
        ...
        investissements_.categories[props.categoryIndex].investments[props.index]["name"] = event.target.value
    ...
    const handleChangeAmount = (event) => {
        ...
        const investissements_ = { ...investissements }
        investissements_.categories[props.categoryIndex].investments[props.index]["amount"] = amount
        setInvestissements(investissements_)
    }
