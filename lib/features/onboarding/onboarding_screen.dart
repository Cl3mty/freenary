...
class OnboardingScreen extends StatefulWidget {
  ...
  const OnboardingScreen({super.key, required this.vaultFolderService, required this.onVaultReady});
        ...
        child: ConstrainedBox(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Icon(LucideIcons.folderOpen, size: 56, color: Theme.of(context).colorScheme.primary),
                const SizedBox(height: 24),
                const Text('Bienvenue sur Freenary', textAlign: TextAlign.center).large().large().medium(),
                ...
                PrimaryButton(
                  ...
                  child: Text(_loading ? 'Création...' : 'Choisir un emplacement'),
                ),
                if (_error != null) ...[
